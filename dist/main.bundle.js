...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.socket.on('numberOfOnlineUsers', function (numberOfOnlineUsers) {
            ...
            if (!_this.myMessage['username'])
                _this.myMessage['username'] = 'guest' + (_this.numberOfOnlineUsers ? _this.numberOfOnlineUsers : '');
            if (!_this.myMessage['avatar'])
                _this.myMessage['avatar'] = 'assets/images/avatars/' + (Math.floor(Math.random() * (10 - 1)) + 1) + '.jpg';
        });
    ...
    AppComponent.prototype.sendMessage = function (e) {
        e.preventDefault();
    ...
    AppComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_2__services_messages_service__["a" /* MessagesService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_messages_service__["a" /* MessagesService */]])
    ], AppComponent);
    return AppComponent;
}());
